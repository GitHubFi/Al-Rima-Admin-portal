...
class AddTwoBedRoom extends Component {
    constructor() {
        super();
        this.state = {
            Notification1: '',
            ...
            uploadTask2.on('state_changed',
                ...
                () => {
                    ...
                    storage.ref(`Bed_One/images`).child(imageObj2.name).getDownloadURL().then(url2 => {
                        ...
                        dbConfig.database().ref("realState/Add_Property").child(`Bed_Two_property`).push({
                            url: this.state.url,
                            url1: this.state.url2,
                            url2: this.state.url2,
                            // url3: this.state.url3,
    ...
    render() {
        ...
        return (
            ...
            >
                <Header as='h1' style={{ paddingTop: 60, paddingLeft: 10 }}>Add Details For Two Bed</Header>
                <Divider inverted />
